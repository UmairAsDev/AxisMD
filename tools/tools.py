...
class LoadToolsConfig:
    def __init__(self) -> None:
        ...
        self.db_username = app_config["user"]
        self.db_password = app_config["password"]
        self.db_name = app_config["db_name"]
        ...
        self.top_p = app_config["voice_llm"]["top_p"]
        self.frequency_penalty = app_config["voice_llm"]["frequency_penalty"]
        self.presence_penalty = app_config["voice_llm"]["presence_penalty"]
